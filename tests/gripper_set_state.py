...
@hydra.main(version_base=None, config_path="./conf", config_name="gripper_set_state")
def main(cfg: DictConfig) -> None:
    ...
    target = 1  # start with the gripper open
    ...
    while running:
        ...
        log.debug(f"Setting gripper state: {target}")
        gripper.set_state(target, speed=gripper_speed, force=gripper_force)
